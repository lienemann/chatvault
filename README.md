...
chatvault chat digest "Birthday Alice" --last 1000 -o digest.md
chatvault chat digest "+41 79 000 11 22" --format jsonl # 1:1 by phone, JSONL
chatvault chat export "John Doe" --out ./john      # md + jsonl + media/
chatvault search "Restaurant" --since 2026-01-01
chatvault timeline "Alice" --limit 20
