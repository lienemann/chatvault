...
def rows(cur: sqlite3.Cursor) -> Iterable[sqlite3.Row]:
    # The typeshed signature for row_factory is narrower than the runtime
    # contract; assign via setattr so mypy versions on both sides of the
    # stub change accept the call.
    setattr(cur, "row_factory", sqlite3.Row)  # noqa: B010
    yield from cur
